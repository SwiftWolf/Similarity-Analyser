...
public class JavaParser/*@bgen(jjtree)*/implements JavaParserTreeConstants, JavaParserConstants {/*@bgen(jjtree)*/
	...
	public static SimpleNode parseFile(String filename){
		JavaParser parser;
	...
	final public void CharacterType() throws ParseException {
		/*@bgen(jjtree) CharacterType */
		SimpleNode jjtn000 = new SimpleNode(JJTCHARACTERTYPE);
		boolean jjtc000 = true;
		jjtree.openNodeScope(jjtn000);
		try {
	...
	final public void VoidType() throws ParseException {
		...
		SimpleNode jjtn000 = new SimpleNode(JJTVOIDTYPE);
		boolean jjtc000 = true;
		jjtree.openNodeScope(jjtn000);
		try {
	...
	final public void SwitchLabelBlock() throws ParseException {
		/*@bgen(jjtree) SwitchLabelBlock */
		SimpleNode jjtn000 = new SimpleNode(JJTSWITCHLABELBLOCK);
		boolean jjtc000 = true;
		jjtree.openNodeScope(jjtn000);
		try {
			label_39:
